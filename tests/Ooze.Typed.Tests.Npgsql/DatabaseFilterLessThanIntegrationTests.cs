...
public class DatabaseFilterLessThanIntegrationTests(NpgsqlFixture fixture)
    : IClassFixture<NpgsqlFixture>
{
    ...
    {
        using var scope = fixture.CreateServiceProvider<PostLessThanFiltersProvider>().CreateScope();
