...
public class DatabaseFilterOutOfRangeThanIntegrationTests(NpgsqlFixture fixture)
    : IClassFixture<NpgsqlFixture>
{
    ...
    {
        var from = new DateTime(2022, 1, 1, default, default, default, DateTimeKind.Utc);
        var to = new DateTime(2022, 2, 20, default, default, default, DateTimeKind.Utc);
