...
public class DatabaseFilterNotEqualIntegrationTests(NpgsqlFixture fixture)
    : IClassFixture<NpgsqlFixture>
{
    [Theory]
    [InlineData(1)]
    [InlineData(5)]
    ...
    {
        using var scope = fixture.CreateServiceProvider<PostNotEqualFiltersProvider>().CreateScope();
        ...
        int day)
    {
        ...
        var filterDate = new DateTime(year, month, day, default, default, default, DateTimeKind.Utc);
        IQueryable<Post> query = context.Posts;
        query = oozeResolver.WithQuery(query)
